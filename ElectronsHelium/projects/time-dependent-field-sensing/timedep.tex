...
\begin{itemize}
  ...
  pathfinder~\cite{silvafeaver2017design}, now followed by the GUT-scale-motivated
  DMRadio-Core design~\cite{ankel2026dmradiocore}) already cover a broad low-mass window
